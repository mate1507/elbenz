...
const DB_USER = process.env.DB_USER || "wufyccyy";
const DB_HOST = process.env.DB_HOST || "abul.db.elephantsql.com";
const DB_NAME = process.env.DB_NAME || "wufyccyy";
const DB_PW = process.env.DB_PW || "ACRiYJUk8NgLDRQRtL-sm3rrcdOCtXTq";
 ...
 */
app.post("/postgresql/co2Query", async (req, res) => {
  try {
    // Lav query
    const query = `SELECT * from co2_elbil`;
